class HomeController < ApplicationController
    ...
    before_filter :setting, :only => [:index, :view, :update]
    ...
    def modalclass
        ...
        if @listall=='1'
            ...
            if @query=="like"
                ...
                @modal_class = ConceptDn.find_by_sql(["SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code like ?  AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' AND a.term_organization_name like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.language_code like ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.term_content <>  '' AND a.term_organization_name like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code like ? AND a.term_content like ? AND a.term_organization_name like ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT 0,100 ","%#{@language}%","%#{@class_name}%","%#{@organization}%","%#{@language}%","%#{@class_name}%","%#{@organization}%","%#{@language}%","%#{@class_name}%","%#{@organization}%"]) 
                    ...
                    # @modal_class = ConceptDn.find_by_sql(["SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT 0,100 ","%#{@class_name}%","%#{@class_name}%"]) 
                    ...
                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_organization_name like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  ''  AND a.term_organization_name like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = 'en' AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''AND a.term_organization_name like ?) LIMIT 0,100 ","%#{@organization}%","%#{@organization}%","%#{@organization}%"]) 
                    ...
                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code like ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.language_code like  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code like ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT 0,100 ","%#{@language}%","%#{@language}%","%#{@language}%"]) 
                    ...
                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' AND a.term_organization_name like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.term_content <>  ''  AND a.term_organization_name like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_content like ? AND a.term_organization_name like ?) LIMIT 0,100 ","%#{@class_name}%","%#{@organization}%","%#{@class_name}%","%#{@organization}%","%#{@class_name}%","%#{@organization}%"]) 


                elsif @class_name!='' && @organization=='' && @language!=''
                     # @modal_class = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,a.language_code,b.Class_id FROM `concept_dn` a left join `corp_ignames` b ON a.concept_id=b.Class_id where a.concept_type_ID = ? and a.term_content!= ? AND a.language_code = ? AND a.term_content like ? ORDER BY `b`.`Class_Name` DESC Limit 100",'0161-1#CT-01#1','',@language,"%#{@class_name}%"])

                     @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like  ? AND  a.language_code like  ? AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.language_code like ? AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.term_content like  ? AND a.language_code like ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' ) LIMIT 0,100 ","%#{@class_name}%",
                    ...
                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.term_organization_name like ? AND a.language_code like  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.term_organization_name like ? AND a.language_code like  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE  a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_organization_name like ? AND a.language_code like  ?) LIMIT 0,100 ","%#{@organization}%","%#{@language}%","%#{@organization}%","%#{@language}%","%#{@organization}%","%#{@language}%"]) 
        ...
        if @listprop == '1'
            ...
            if @query=="like"
                if @property_name!=''  && @organization_prop!='' && @language_prop!=''
                    ...
                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name like? AND language_code like ? AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name like ? AND language_code like ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300",
                        "%#{@organization_prop}%","%#{@language_prop}%","%#{@property_name}%","%#{@organization_prop}%","%#{@language_prop}%","%#{@property_name}%"])  
                   ...
                   # @modal_prop = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,b.propertyRef FROM `concept_dn` a left join `xml_rg` b ON a.concept_id=b.propertyRef where term_organization_name = ? AND concept_type_ID = ? AND term_content!= ? ORDER BY `b`.`Class_Name` DESC Limit 100", @organization_prop,'0161-1#CT-02#1',''])
                    ...
                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name like ?  AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300",
                        "%#{@organization_prop}%","%#{@organization_prop}%"])         
                    ...
                    # @modal_prop = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,b.propertyRef FROM `concept_dn` a left join `xml_rg` b ON a.concept_id=b.propertyRef where language_code = ? AND concept_type_ID = ? AND term_content!= ? ORDER BY `b`.`Class_Name` DESC Limit 100",@language_prop,'0161-1#CT-02#1',''])     
                     ...
                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code like ?  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND language_code like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300","%#{@language_prop}%","%#{@language_prop}%"])  

                elsif @property_name!='' && @organization_prop!='' && @language_prop==''
                    # @modal_prop = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,b.propertyRef FROM `concept_dn` a left join `xml_rg` b ON a.concept_id=b.propertyRef where term_content like ? AND term_organization_name = ? AND concept_type_ID = ? AND term_content!= ? ORDER BY `b`.`Class_Name` DESC Limit 100","%#{@property_name}%",@organization_prop,'0161-1#CT-02#1',''])   

                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name like ?  AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name like ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300","%#{@organization_prop}%","%#{@property_name}%","%#{@organization_prop}%","%#{@property_name}%"])      
                    ...
                    # @modal_prop = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,b.propertyRef FROM `concept_dn` a left join `xml_rg` b ON a.concept_id=b.propertyRef where term_content like ? AND language_code = ? AND concept_type_ID = ? AND term_content!= ? ORDER BY `b`.`Class_Name` DESC Limit 100","%#{@property_name}%",@language_prop,'0161-1#CT-02#1','']) 
                     ...
                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code like? AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND  language_code like ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300","%#{@language_prop}%","%#{@property_name}%","%#{@language_prop}%","%#{@property_name}%"])  

                elsif @property_name=='' && @organization_prop!='' && @language_prop!=''
                    # @modal_prop = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,b.propertyRef FROM `concept_dn` a left join `xml_rg` b ON a.concept_id=b.propertyRef where term_content like ? AND language_code = ? AND concept_type_ID = ? AND term_content!= ? ORDER BY `b`.`Class_Name` DESC Limit 100","%#{@property_name}%",@language_prop,'0161-1#CT-02#1','']) 

                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name like ? AND language_code like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name like ? AND language_code like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300","%#{@organization_prop}%","%#{@language_prop}%","%#{@organization_prop}%","%#{@language_prop}%"])   
               ...
               if @property_name!=''  && @organization_prop!='' && @language_prop!=''
                    # @modal_prop = ConceptDn.find_by_sql(["SELECT distinct a.term_content,a.concept_ID,a.term_ID,a.definition_ID,a.term_organization_name,a.definition_content,a.language_name,b.propertyRef FROM `concept_dn` a left join `xml_rg` b ON a.concept_id=b.propertyRef where term_content like ? AND term_organization_name = ? AND language_code = ? AND concept_type_ID = ? AND term_content!= ? ORDER BY `b`.`Class_Name` DESC Limit 100","#{@property_name}%",@organization_prop,@language_prop,'0161-1#CT-02#1',''])
                        ...
                        @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name like ? AND language_code like ? AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name like ? AND language_code like ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT 0,300","#{@organization_prop}%","#{@language_prop}%","#{@property_name}%","#{@organization_prop}%","#{@language_prop}%","#{@property_name}%"]) 
    ...
    def addnew
        ...
        if @class_prop
            ...
            #     @len_ld=res["length_LD"].to_i
            #     @len_sd=res["length_SD"].to_i
    ...
    def update    
        ...
        if params[:update]=="UPDATE"
            ...
            if @imagecount==1
                ...
                @v=params[:prop_value].reject(&:blank?)
                 # @len_sd=params[:len_sd].to_i
                 # @len_ld=params[:len_ld].to_i
    ...
    def loadexisting
        ...
        #         @con = CorpIgname.where("Class_id = ? AND datedeleted = ?", @concept_Id,'0000-00-00 00').select(:igid)
        #     }
        # end
    end
    def template_search
