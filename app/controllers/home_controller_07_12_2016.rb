    ...
    def modalclass
        ...
        if @listall=='1'
            ...
            if @query=="like"
                ...
                @modal_class_count = ConceptDn.count_by_sql(["SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code = ? and term_organization_name = ? and term_content like ?","#{@language}","#{@organization}","%#{@class_name}%"])

                @modal_class = ConceptDn.find_by_sql(["SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ?  AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' AND a.term_organization_name = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.term_content <>  '' AND a.term_organization_name = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ? AND a.term_content like ? AND a.term_organization_name = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT #{@startfrom},#{@per_page} ","#{@language}","%#{@class_name}%","#{@organization}","#{@language}","%#{@class_name}%","#{@organization}","#{@language}","%#{@class_name}%","#{@organization}"]) 

 
                elsif @class_name!='' && @organization=='' && @language==''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code ='en' and term_content like ?","%#{@class_name}%"])

                    @modal_class =  ConceptDn.find_by_sql(["SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code =  'en' and a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b  WHERE a.language_code =  'en' and a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '') LIMIT  #{@startfrom},#{@per_page}","%#{@class_name}%","%#{@class_name}%","%#{@class_name}%"])


 
                elsif @organization!='' && @class_name=='' && @language==''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code = 'en'and term_organization_name = ? ","%#{@organization}%"])

                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_organization_name = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  ''  AND a.term_organization_name = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = 'en' AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''AND a.term_organization_name = ?) LIMIT #{@startfrom},#{@per_page} ","#{@organization}","#{@organization}","#{@organization}"]) 


                elsif @language!='' && @organization=='' && @class_name==''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code  = ?","#{@language}"])

                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT #{@startfrom},#{@per_page} ","#{@language}","#{@language}","#{@language}"]) 
             
                elsif @class_name!='' && @organization!='' && @language==''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code ='en' and term_organization_name = ? and term_content like ?","#{@organization}","%#{@class_name}%"])

                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' AND a.term_organization_name = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.term_content <>  ''  AND a.term_organization_name = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_content like ? AND a.term_organization_name = ?) LIMIT #{@startfrom},#{@per_page} ","%#{@class_name}%","#{@organization}","%#{@class_name}%","#{@organization}","%#{@class_name}%","#{@organization}"]) 


                elsif @class_name!='' && @organization=='' && @language!=''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code = ? and term_content like ?","#{@language}","%#{@class_name}%"])

                     @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like  ? AND  a.language_code =  ? AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content like ? AND a.language_code = ? AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.term_content like  ? AND a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' ) LIMIT #{@startfrom},#{@per_page} ","%#{@class_name}%",
                         "#{@language}","%#{@class_name}%","#{@language}","%#{@class_name}%","#{@language}"]) 


                elsif @class_name=='' && @organization!='' && @language!=''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code ='#{@language}' and term_organization_name = ? and term_content like ?","#{@organization}","#{@class_name}%"])

                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.term_organization_name = ? AND a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.term_organization_name = ? AND a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE  a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_organization_name = ? AND a.language_code =  ?) LIMIT #{@startfrom},#{@per_page} ","#{@organization}","#{@language}","#{@organization}","#{@language}","#{@organization}","#{@language}"]) 
                ...
                if @class_name!=''  && @organization!='' && @language!=''
                     ...
                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code = ? and term_organization_name = ? and term_content = ?","#{@language}","#{@organization}","#{@class_name}"])

                   @modal_class = ConceptDn.find_by_sql(["SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ?  AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content = ? AND a.term_content <>  '' AND a.term_organization_name = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content = ? AND a.term_content <>  '' AND a.term_organization_name = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ? AND a.term_content = ? AND a.term_organization_name = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT #{@startfrom},#{@per_page} ","#{@language}","#{@class_name}","#{@organization}","#{@language}","#{@class_name}","#{@organization}","#{@language}","#{@class_name}","#{@organization}"]) 

                elsif @class_name!='' && @organization=='' && @language==''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code ='en' and term_content = ?","%#{@class_name}"])

                   @modal_class =  ConceptDn.find_by_sql(["SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code =  'en' and a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content like ? AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content = ? AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b  WHERE a.language_code =  'en' and a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content  = ? AND a.term_content <>  '') LIMIT #{@startfrom},#{@per_page}","#{@class_name}%","#{@class_name}%","#{@class_name}%"])
                    ...
                    @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  ''  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '') LIMIT #{@startfrom},#{@per_page} ","#{@language}","#{@language}","#{@language}"]) 
                     ...
                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code ='en' and  term_organization_name = ? and term_content = ?","#{@organization}","#{@class_name}"])

                       @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content = ? AND a.term_content <>  '' AND a.term_organization_name = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content = ? AND a.term_content <>  ''  AND a.term_organization_name = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' AND a.term_content = ? AND a.term_organization_name = ?) LIMIT #{@startfrom},#{@per_page} ","#{@class_name}","#{@organization}","#{@class_name}","#{@organization}","#{@class_name}","#{@organization}"]) 


                elsif @class_name!='' && @organization=='' && @language!=''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code = ? and term_content = ?","#{@language}","#{@class_name}"])

                        @modal_class = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'s' FROM  `concept_dn` a,  `corp_ignames` b WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content =  ? AND  a.language_code =  ? AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,a.language_code,'y' FROM  `concept_dn` a WHERE a.concept_type_ID =  '0161-1#CT-01#1' AND a.term_content = ? AND a.language_code = ? AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `corp_ignames` b WHERE a.term_content =  ? AND a.language_code = ? AND a.concept_type_ID =  '0161-1#CT-01#1' AND a.concept_id = b.Class_id AND a.term_content <>  '' ) LIMIT #{@startfrom},#{@per_page} ","#{@class_name}","#{@language}","#{@class_name}","#{@language}","#{@class_name}","#{@language}"]) 


                elsif @class_name=='' && @organization!='' && @language!=''

                     @modal_class_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-01#1' and  language_code = ? and term_organization_name = ? ","#{@language}","#{@organization}"])
        ...
        if @listprop == '1'
            ...
            if @query=="like"
                ...
                if @property_name!=''  && @organization_prop!='' && @language_prop!=''
                     ...
                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where  concept_type_ID = '0161-1#CT-02#1' and  language_code = ? and term_organization_name = ? and term_content like ?","#{@language_prop}","#{@organization_prop}","%#{@property_name}%"])

                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name =? AND language_code = ? AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name =? AND language_code = ? AND term_content like ?) LIMIT #{@startfrom},#{@per_page}","#{@organization_prop}","#{@language_prop}","%#{@property_name}%","#{@organization_prop}","#{@language_prop}","%#{@property_name}%","#{@organization_prop}","#{@language_prop}","%#{@property_name}%",])  


                elsif @property_name!='' && @organization_prop=='' && @language_prop==''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code ='en' and term_content like ?","%#{@property_name}%"])

                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  ''  AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  ''  AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_content like ?) LIMIT #{@startfrom},#{@per_page}","%#{@property_name}%","%#{@property_name}%","%#{@property_name}%"])  

                elsif @organization_prop!='' && @property_name=='' && @language_prop==''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code ='en' and term_organization_name = ? ","#{@organization_prop}"])

                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ?  AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ?) LIMIT #{@startfrom},#{@per_page}","%#{@organization_prop}%","%#{@organization_prop}%","%#{@organization_prop}%"])         

                elsif @language_prop!='' && @organization_prop=='' && @property_name==''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code = ?","%#{@language_prop}%"])

                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code = ?  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND language_code = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  ''  AND language_code = ? ) LIMIT #{@startfrom},#{@per_page}","#{@language_prop}","#{@language_prop}","#{@language_prop}"])  

                elsif @property_name!='' && @organization_prop!='' && @language_prop==''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code ='en' and term_organization_name = ? and term_content like ?","#{@organization_prop}","%#{@property_name}%"])

                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ?  AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ?  AND term_content like ?) LIMIT #{@startfrom},#{@per_page}","#{@organization_prop}","%#{@property_name}%","#{@organization_prop}","%#{@property_name}%","#{@organization_prop}","%#{@property_name}%"])      

                elsif @property_name!='' && @organization_prop=='' && @language_prop!=''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code = ?  and term_content like ?","#{@language_prop}","%#{@property_name}%"])

                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code =? AND term_content like ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND  language_code = ? AND term_content like ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code =? AND term_content like ?) LIMIT #{@startfrom},#{@per_page}","#{@language_prop}","%#{@property_name}%","#{@language_prop}","%#{@property_name}%","#{@language_prop}","%#{@property_name}%"])  

                elsif @property_name=='' && @organization_prop!='' && @language_prop!=''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code ='#{@language_prop}' and term_organization_name = ? and term_content like ?","#{@organization_prop}","#{@property_name}%"])

                     @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ?) LIMIT #{@startfrom},#{@per_page}","#{@organization_prop}","#{@language_prop}","#{@organization_prop}","#{@language_prop}","#{@organization_prop}","#{@language_prop}"])   

                elsif @property_name=='' && @organization_prop=='' && @language_prop==''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1'"])

                   @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '') LIMIT #{@startfrom},#{@per_page}"]) 
                end    
            elsif @query=="startwith"
               if @property_name!=''  && @organization_prop!='' && @language_prop!=''
                    ...
                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code = ?  UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND language_code = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND language_code = ?) LIMIT #{@startfrom},#{@per_page}","#{@language_prop}","#{@language_prop}","#{@language_prop}","#{@language_prop}","#{@language_prop}","#{@language_prop}"]) 
                   ...
                   @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_content like? AND language_code = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_content like ? AND language_code = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_content like ? AND language_code = ?) LIMIT #{@startfrom},#{@per_page}","#{@property_name}%","#{@language_prop}","#{@property_name}%","#{@language_prop}","#{@property_name}%","#{@language_prop}"])   

                elsif @property_name=='' && @organization_prop!='' && @language_prop!=''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code = ? and term_organization_name like ?","#{@language_prop}","#{@organization_prop}"])

                      @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  ? AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ?) LIMIT #{@startfrom},#{@per_page}","#{@organization_prop}","#{@language_prop}","#{@organization_prop}","#{@language_prop}","#{@organization_prop}","#{@language_prop}","#{@language_prop}","#{@language_prop}","#{@language_prop}"])  
                ...
                if @property_name!=''  && @organization_prop!='' && @language_prop!=''
                        ...
                        @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? AND term_content = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? AND term_content = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ? AND language_code = ? AND term_content = ? ) LIMIT #{@startfrom},#{@per_page}","#{@organization_prop}","#{@language_prop}","#{@property_name}","#{@organization_prop}","#{@language_prop}","#{@property_name}","#{@organization_prop}","#{@language_prop}","#{@property_name}"])  

                elsif @property_name!='' && @organization_prop=='' && @language_prop==''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code ='en' and term_content like ?","#{@property_name}%"])

                      @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  ''  AND term_content = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  ''  AND term_content = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  ''  AND term_content = ? ) LIMIT #{@startfrom},#{@per_page}","#{@property_name}","#{@property_name}","#{@property_name}"])       
                     ...
                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code ='en' and term_organization_name = ? and term_content = ?","#{@organization_prop}","#{@property_name}"])

                      @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ?  AND term_content = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_organization_name = ? AND term_content = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_organization_name = ?  AND term_content = ? ) LIMIT #{@startfrom},#{@per_page}","#{@organization_prop}","#{@property_name}","#{@organization_prop}","#{@property_name}","#{@organization_prop}","#{@property_name}"])    

                elsif @property_name!='' && @organization_prop=='' && @language_prop!=''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code = ? and term_content = ?","#{@language_prop}","#{@property_name}"])

                    @modal_prop = ConceptDn.find_by_sql([" SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'s' FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  '' AND term_content = ? AND language_code = ? UNION SELECT DISTINCT a.term_content, a.concept_ID, a.term_ID, a.definition_ID, a.term_organization_name, a.definition_content, a.language_name,'y' FROM  `concept_dn` a WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.term_content <>  '' AND term_content = ? AND language_code = ? AND a.concept_ID not in (SELECT DISTINCT a.concept_ID FROM  `concept_dn` a,  `xml_rg` b WHERE a.language_code =  'en' AND a.concept_type_ID =  '0161-1#CT-02#1' AND a.concept_id = b.propertyRef AND a.term_content <>  ''  AND term_content = ? AND language_code = ?) LIMIT #{@startfrom},#{@per_page}","#{@property_name}","#{@language_prop}","#{@property_name}","#{@language_prop}","#{@property_name}","#{@language_prop}"])   

                elsif @property_name=='' && @organization_prop!='' && @language_prop!=''

                     @modal_prop_count = ConceptDn.count_by_sql([" SELECT count(*) from `concept_dn` where concept_type_ID = '0161-1#CT-02#1' and language_code = ? and term_organization_name = ? ","#{@language_prop}","#{@organization_prop}"])
